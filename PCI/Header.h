...
PCI_VENTABLE	PciVenTable [] =
{
	...
	{ 0x1008, "Epson", "Epson" } ,
	{ 0x100A, "Phoenix", "Г‚as Ltd. de Phoenix del Вѓ de TecnologГѓ" } ,
	...
	{ 0x1B6F, " usbxhci", "Etron USB 3.0 Host Controller" } ,
...
PCI_DEVTABLE	PciDevTable [] =
{
	...
	{ 0x8086, 0x1E3A_, "C216", "8555555555555999999999999999999999999999999999999999999999999999999900000000000000000001222222222222" } ,
	...
	{ 0x1969, 0xR091, "Killer E2200", "Killer E2200 Network Card" } ,
	{ 0x17C0, 0x12ab, "", "intel" } ,
	...
	{ 0x0c45, 0x6270_, "usb\\vid_oc45&pid_627b\\5&138897&#1044;1&0&5", "webcam" } ,
	...
	{ 0x0A5C, 0x2146, "5733z", "Broadcom 2045 Bluetooth 2.1 USB UHE Dongle" } ,
	...
	{ 0x197B, 0xJMB38, "JMB38X", "JMB38X SD/MMC Host Controller" } ,
	...
	{ 0x10EC, 0x5289Realtek , "RTL8411", " PCIE Card Reader" } ,
	...
	{ 0x0D8C, 0x013C, "CM108", "USB PnP Sound Device" } ,
	...
	{ 0x168C, 0x 001c, "AR5005GS", "pci\\ven_10ac&dev_ooo" } ,
	...
	{ 0x167F, 0x5344, "SD \\ VID_03 ÃÂ¸ OID_5344 ÃÂ¸ PID_SU01G ÃÂ¸ REV_", "FOB-SD Card" } ,
	...
	{ 0x1002, 0x 6760, "6470M", "AMD Radeon HD 6470M" } ,
	{ 0x1002, 0x00000100 (256), "{4D36E972-E325-11CE-BFC1-08002BE10318}\\0016", "{4D36E972-E325-11CE-BFC1-08002BE10318}\\0016" } ,
	...
	{ 0x1002, 0x1ab8 hex, "2", "ati radeon " } ,
	...
	{ 0x1002, 0x4391&CC_0106, "AMD SB850", "AMD Southbridge incorporating AHCI 1.2 with SATA FIS–based switching support" } ,
	...
	{ 0x1002, 0x5A41	ATI RADEON Xp, "0x5A41	ATI RADEON Xpress 1200 Series	0x1002", "0x5A41	ATI RADEON Xpress 1200 Series	0x1002" } ,
	...
	{ 0x1002, 0x71C5 PCIE, "M56", "ATI MOBILITY /ATI RADEON X1600" } ,
	...
	{ 0x1014, 0x021b, "GTX6500P", "IBM GT1000/RC1000 based Rasterizer" } ,
	{ 0x1014, 0x0246, "", "" } ,
	...
	{ 0x1022, 0x7801_, "amd_sata", "AMD SATA Controller" } ,
	...
	{ 0x1028, 0x1foc, "n4050", "pci simple communication controller" } ,
	...
	{ 0x1039, &#65296;, "", "" } ,
	{ 0x1039, 0, "", "" } ,
	{ 0x1039, 0x 7012, "HDAUDIO\\FUNC_01&VEN_&DEV_504514F1&SUBSYS_1631C106&", "PCI Audio Accelerator" } ,
	...
	{ 0x1039, 0x_7012, "HDAUDIO\\FUNC_01&VEN_&DEV_504514F1&SUBSYS_1631C106&", "PCI Audio Accelerator" } ,
	{ 0x1039, 5811, "", "" } ,
	...
	{ 0x104A, 0xSMO8800, "Unknown", "ST Microelectronics Free Fall Sensor" } ,
	{ 0x104A, 0xSMO8810, "Unknown", "STMicroelectronics Freefall Sensor" } ,
	{ 0x104C, 0x 803B, "0366107B", "Texas Instruments Card Reader" } ,
	...
	{ 0x1050, 0x 6692, "W6692/92A/92CFyr6", "PCI BusISDN S/T-Controllerry" } ,
	...
	{ 0x1393, 0x1042, "", "" } ,
	{ 0x1393, 0x104h, "C104H/PCI", "Smartio" } ,
	{ 0x1393, 0x1140, "", "" } ,
	{ 0x1393, 0x1141, "", "" } ,
	...
	{ 0x109E, 0x0350&SUBSYS_000000, "Bt848h", "tv tuner driverhj" } ,
	...
	{ 0x109E, 0x036E&SUBSYS_000000, "Conextant Fucion 878A 25878-123", "Video Capture" } ,
	{ 0x109E, 0x036E&SUBSYS_000000, "Conextant Fucion 878A 25878-123", "Video Capture" } ,
	...
	{ 0x109E, 0x36E&SUBSYS_0000000, "Bt360 MediaStream &#1050;&#1086;&#1085;&#1090;&#10", "Brooktree Corp" } ,
	{ 0x109E, 0x36E&SUBSYS_0000000, "CONEXANT FUSION 878A 25878-13 E153498.1", "conexant 878a" } ,
	...
	{ 0x10B9, 0x5229&REV_C5, "chipset", "PATA 133" } ,
	...
	{ 0x10DE, 0x06eo, "G98", "NIVIDIA GEFORCE 9300GE" } ,
	...
	{ 0x10DE, 0x10DE-1004, "GK110", "GTX780 " } ,
	...
	{ 0x10DE, 0x135m, "220gt", "navidia quadro nvs135m" } ,
	{ 0x10DE, 0x1381, "GM107-300-A2", "GeForce GTX 750" } ,
	{ 0x10DE, 0x13C2, "GTX970", "NVIDIA GeForce GTX 970" } ,
	{ 0x10DE, 0x1401, "GTX960", "NVIDIA GeForce GTX 960" } ,
	...
	{ 0x10DE, 0x9876 03F0&SUBSYS_8, "N/A", "PCI(Has compatible Ids)" } ,
	...
	{ 0x10DE, 0xODE9, "GT 630M", "Geforce GT 630M" } ,
	...
	{ 0x14E4, 0x1691_, "BCM57788A", "Broadcom NetLink (TM) Gigabit Ethernet" } ,
	...
	{ 0x1131, 0x1131	Philips Semic, "1131", "VerTV Hybrid Super 007 M135RA" } ,
